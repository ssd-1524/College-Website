...
import doctorImage from '../../Images/Doc5.jpg'; // Ensure the doctor image path is correct
      ...
      <div className='p-10'>
        <div className='flex gap-20 items-center justify-center'>
          ...
          <div className="flex flex-col items-start mb-5">
            <h1 className='text-4xl flex items-baseline text-teal-800 mb-3' style={{ fontFamily: 'Kaisei HarunoUmi, sans-serif' }}>Dr. Gaurav Joshi<p className='text-lg text-teal-600' style={{ fontFamily: 'Kaisei HarunoUmi, sans-serif' }}>(IRIS HOSPITAL)</p></h1>
